...
//        print_r($row);
        ...
        <br>
        <div id="open_form_link" ><a style="text-decoration: none;" class="reply" href="">+</a></div>
        <div id="close_form_link" ><a style="text-decoration: none;" class="reply" href="">‒</a></div>
        <?php
